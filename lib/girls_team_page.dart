...
class GirlsTeamPage extends StatefulWidget {
  final bool selectingTeam;
  const GirlsTeamPage({super.key, this.selectingTeam = false});
  @override
  State<GirlsTeamPage> createState() => _GirlsTeamPageState();
}

class _GirlsTeamPageState extends State<GirlsTeamPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (userId != null) {
      _db = FirebaseDatabase.instance.ref().child('teams/$userId/girls');
        ...
        builder: (context, setState) {
          ...
          return AlertDialog(
            ...
            title: Row(children: [
              ...
              Text('Add Girls Team', style: TextStyle(color: isDark ? Colors.white : const Color(0xFF2C3E50), fontWeight: FontWeight.bold, fontSize: 20)),
            ]),
            content: Container(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          ...
          const SizedBox(width: 12),
          const Text('Girls Teams', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22)),
        ]),
      ...
      body: teams.isEmpty ? FadeTransition(opacity: _fadeAnimation, child: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 16),
            Text('No Girls Teams Yet', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF2C3E50))),
